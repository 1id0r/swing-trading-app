        ...
        {!isLoadingPositions && (
          <div className='theme-card   p-4   '>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='text-center'>
                <div className='text-2xl font-bold theme-text-primary  '>${(safeStats.totalValue || 0).toFixed(2)}</div>
            ...
            <div className='mt-4 pt-4 border-t border-gray-700 grid grid-cols-2 gap-4 text-sm'>
              <div>
                ...
                <div className='theme-text-primary   font-medium'>${(safeStats.totalCost || 0).toFixed(2)}</div>
              </div>
              <div>
                ...
                <div key={position.id} className='theme-card   p-4   '>
                  <div className='flex items-center justify-between mb-3'>
                    <div className='flex items-center gap-3'>
                      <div className='w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center theme-text-primary   font-bold text-sm'>
                        ...
                        <span
                          className={`theme-text-primary   font-bold text-sm ${position.logo ? 'hidden' : 'flex'}`}
                  ...
                  <div className='grid grid-cols-3 gap-4 text-sm'>
                    <div>
                      ...
                      <div className='theme-text-primary   font-medium'>{totalShares.toLocaleString()}</div>
                    </div>
                    <div>
                      <div className='theme-text-secondary  '>Avg Price</div>
                      <div className='theme-text-primary   font-medium'>${averagePrice.toFixed(2)}</div>
                    </div>
                    <div>
