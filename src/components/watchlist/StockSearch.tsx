      ...
      <div className='flex gap-2'>
        <div className='relative flex-1'>
          ...
          <input
            ...
            className='w-full pl-10 pr-4 py-2 border border-grey-200 rounded text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none'
          />
        ...
        <select
          ...
          className='px-3 py-2   rounded text-white focus:border-blue-500 focus:outline-none'
        >
          {folders.map((folder) => (
